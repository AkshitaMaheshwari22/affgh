                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" id="eventId" name="eventId" maxlength="13" hidden value="<?php echo $id; ?>">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-center">
                                            ...
                                            <img src="images/<?php echo $event['image'] != "" ? $event['image'] : "noimage.png"; ?>" style="width: 100%;" alt="uploaded image" id="eventImagePreview">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="margin: 2rem 0rem;">
                                        <button type="submit" id="submit" class="btn btn-default btn-block btn-lg">Update</button>
                                    </div>
                                </div>
                        </form>
                    </div>
